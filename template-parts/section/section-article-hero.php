        ...
        >
            <div class="lg:grid lg:grid-cols-[1fr_auto] lg:gap-10">
                <div class="grid gap-2 lg:self-center lg:max-w-[37.5rem]">
                    <p class="text-sm font-medium tracking-tight  lg:text-lg" data-animation-fade-in>
                        <?php echo $eyebrow; ?>
                    </p>
                    <h1 class="text-[2rem] font-medium tracking-tight leading-tight lg:text-[3.5rem]" data-animation-split-text>
            ...
            <div class="flex justify-between items-center pt-4 border-t lg:pt-6 <?php echo $border_color; ?>">
                <div>
                    <p class="uppercase text-sm tracking-tight font-semibold flex items-center gap-3 lg:text-lg lg:font-medium" data-animation-fade-in>
                ...
                <div>
                    <button type="button" class="flex items-center gap-3 share-button" aria-label="Compartir" data-animation-fade-in>
