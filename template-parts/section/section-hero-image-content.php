    ...
    <div class="container relative z-10 h-full grid grid-rows-[1fr_auto] lg:grid-cols-2 lg:gap-24 lg:grid-rows-none"> 
        <div class="flex items-center lg:order-2">
            <div class="lg:max-w-[30rem]">
                <p class="text-white text-sm tracking-tight font-medium leading-snug mb-4 lg:text-lg lg:mb-6">
                    <?php echo $sub_title; ?>
                </p>
                <h1 class="text-white text-[2rem] tracking-tight font-medium leading-snug mb-4 lg:text-[3.5rem] lg:mb-5">
                    <?php echo $title; ?>
                </h1>
                <p class="text-white tracking-tight font-medium leading-snug lg:text-lg lg:max-w-[24rem]">
        ...
        <div class="relative max-w-[22.375rem] mx-auto lg:order-1 lg:max-w-[38.25rem] lg:w-full lg:self-end">
            ...
            <figure class="absolute top-1/2 -translate-y-1/2 -right-3 max-w-20 lg:max-w-36 lg:bottom-10 lg:-translate-y-0 lg:top-auto">
