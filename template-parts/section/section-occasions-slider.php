            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class('swiper-slide bg-blue flex-col gap-10 lg:gap-0 occasions-slider__item'); ?>>
                ...
                <div class="relative grow flex items-center justify-center">
                    ...
                    <div class="occasions-slider__item-blob-container">
                        <div class="occasions-slider__item-blob-secondary occasions-slider__item-blob-secondary--first">
                        ...
                        <div class="occasions-slider__item-blob">
                            <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 -rotate-6 z-10 text-center w-full max-w-[34.375rem] lg:-translate-y-1/4">
                                <h2 class="text-white text-5xl font-medium mb-5 lg:text-[4rem]">
                                    <?php the_title(); ?>
                                </h2>
        
                                <a href="<?php the_permalink(); ?>" class="bg-white text-blue rounded-[100%] px-7 py-3 block max-w-fit mx-auto font-semibold lg:text-2xl lg:px-14 lg:py-4">
                                    Explorar
                                </a>
                            </div>
                            ...
                            ?>
                                <div class="occasions-slider__item-blob-image" style="background-image: url('<?php echo esc_url($thumbnail_url); ?>');"></div>
                            <?php endif; ?>
                        </div>

                        <div class="occasions-slider__item-blob-secondary occasions-slider__item-blob-secondary--left">
