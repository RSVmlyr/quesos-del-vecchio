...
>
    <!-- gap-[6.125rem] -->
    <div class="container--right flex items-center relative">
        <div class="min-w-[33.4375rem] w-full overflow-hidden instagram-reels__description">
            <div class="min-w-[27.4375rem]">
                <div class="grid gap-6">
                    <p class="text-lg tracking-tight font-medium text-blue">
                        <?php echo $pre_title; ?>
                    </p>
            
                    <h2 class="text-blue text-[3.5rem] font-medium leading-tight tracking-tight">
                        <?php echo $title; ?>
                    </h2>
                </div>
                ...
                <a 
                    ...
                    class="flex gap-3 items-center mt-[2.625rem] text-lg font-medium tracking-tight"
                >
