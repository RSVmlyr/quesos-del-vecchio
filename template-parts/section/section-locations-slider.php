...
<section 
    ...
    class="bg-beige-3 py-20 overflow-hidden"
>
    <div class="container">
        <div class="bg-beige-2 overflow-hidden rounded-[3.5rem] px-4 py-8 lg:px-20 lg:py-20 lg:grid-cols-2 lg:grid lg:items-center">
            <div class="text-center max-w-[25rem] mb-6 lg:mb-0">
                <p class="text-xs font-medium text-blue tracking-tight lg:text-lg lg:font-semibold">
                    <?php echo $eyebrow; ?>
                </p>
    
                <h2 class="text-[2rem] font-medium text-blue tracking-tight leading-tight my-4 lg:text-[3.5rem]">
                    <?php echo $title; ?>
                </h2>
    
                <p class="text-blue tracking-tight leading-tight max-w-64 mx-auto lg:max-w-none lg:text-2xl">
                    <?php echo $description; ?>
                </p>
    
                <a href="<?php echo $link['url']; ?>" class="hidden text-blue bg-orange mt-[3.25rem] rounded-[12.5rem] py-6 px-12 text-lg font-semibold tracking-tight lg:block">  
                    <?php echo $link['title']; ?>
                </a>
            </div>
